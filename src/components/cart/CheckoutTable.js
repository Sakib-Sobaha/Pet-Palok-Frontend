...
function CheckoutTable({ district }) {
    ...
    <div className="overflow-x-auto grid place-content-center">
      <table className="table table-header-group">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td></td>
            <td></td>
            <td className="font-bold">{deliveryFee} Taka</td>
          </tr>
      ...
      <div className="grid place-items-center p-4">
        <h1 className="badge badge-neutral">
          You have to pay {totalPrice + deliveryFee} taka to the delivery
          company as COD
        </h1>
      </div>
    </div>
