  ...
  if (loading) {
    ...
    return (
      <div className="flex-1 bg-base-200 rounded-lg p-4 min-h-screen">
        ...
        <EditPasswordModal element_id="edit_password" userId={userId} />
        ...
        <div className="flex">
          {/* Conditionally render Edit Profile and Change Password buttons */}
          {visitor?.id === userId ? (
            <>
              <button
          ...
          <button 
            ...
            onClick={() => handleChatRoomRedirect(user)}  
          >
            <svg
              viewBox="0 0 512 512"
              xmlns="http://www.w3.org/2000/svg"
