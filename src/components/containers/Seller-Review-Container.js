...
import SingleReivew from "../reviews/Seller-SingleReview";
...
const SellerReviewContainer = ({sellerId}) => {
  ...
  const url = `${process.env.REACT_APP_API_URL}/review/seller/${sellerId}`;
